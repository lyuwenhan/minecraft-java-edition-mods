...
public final class GlideplateServerUtil {
	...
	private static final Component LORE_LINE = Component.translatableWithFallback(
	...
	public static ItemStack createGlideplateServer(ItemStack chestplate) {
		...
		result.set(DataComponents.ITEM_NAME, Component.translatableWithFallback(
	...
	private static CustomModelData mergeCustomModelData(ItemStack stack, ChestplateLevel level) {
		CustomModelData existing = stack.getOrDefault(DataComponents.CUSTOM_MODEL_DATA, CustomModelData.EMPTY);
